...
<?php
//view_customer_payment_report.php
			...
			<div class="panel panel-default">
                <div class="panel-heading">
                	<div class="row">
                    	<div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                            <h3 class="panel-title" style="font-weight:bold;">Customer Payment and Due Report</h3>
                        </div>						
						<br />
                    </div>
                ...
                <div class="panel-body">
					<div class="modal-footer">
    					...
    					<a href="customer_payment_report_print.php?pdf=1&payment_id=<?php echo $payment_id;?>" class="btn btn-info btn-xs">Export to Print/PDF</a>
    				</div>
                	<table id="customer_payment_data" class="table table-bordered table-striped">
                		
							<tr  align="center" >
								<th rowspan="1">Sl. No</th>
								<th rowspan="1">Name of the Customer</th>
						...
						<tbody>
							<?php 
												if(isset($_GET['payment_id']))
													$payment_id = $_GET['payment_id'];
												$query = "
												SELECT c.*,i.inventory_order_total,i.inventory_order_date,customer_details.customer_name
												FROM customer_payment_details as c
												INNER JOIN inventory_order as i ON i.inventory_order_id = c.inventory_order_id
												INNER JOIN customer_details ON customer_details.customer_id = c.customer_id
												";
												if(isset($_GET['payment_id']))
												{
											...
											//					group by(purchase_id)";
												...
												$query .= "order by c.customer_id, c.inventory_order_id, c.date_of_payment";		
											//	group by(purchase_id)
							...
							?>
														<tr>
															...
															<td>
																<label><?php echo $inventory_order_id;?></label>
															</td>
															<td>
																<label><?php echo $inventory_order_date;?></label>
															</td>
															<td>
																<label><?php echo $inventory_order_total;?></label>
															</td>
															<td>
															...
															<td>
																<label><?php echo $cheque_number;?></label>
															</td>
															<td>
																<label><?php echo $cheque_date;?></label>
															</td>
															<td>
																<label><?php echo $cheque_bank_name;?></label>
															</td>
															<td>
							...
							<?php						
													...
													$query1 ="select * from customer_payment where customer_id='".$customer_id."'";
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var customer_paymentdataTable = $('#customer_payment_data').DataTable({
				"processing":true,
				"searching":true,
				"ajax":{
				url:"view_customer_payment.php",
				method:"POST"
				},
				"dom":'lBfrtrip',
				"columnDefs":[
