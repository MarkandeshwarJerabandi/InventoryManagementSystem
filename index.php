...
<script>
	...
	<marquee><span class="blinking" id="alert_action" style="text-align:center;color:red;font-size:26px;font-weight:bold;">
		<?php 
			$msg = get_min_stock_details($connect); 
			if(isset($msg)) 
				echo $msg; 
			else 
				echo '';
	...
	<div class="col-md-3">
		<div class="panel panel-default">
			...
			<div class="panel-body" align="center">
				<h1><?php echo count_total_stock($connect); ?></h1>
			</div>
		</div>
	</div>
