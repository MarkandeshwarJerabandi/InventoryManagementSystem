		...
		<div class="col-lg-21">
			...
			<!--		<br />
                ...
                <div class="panel-body">
					...
					<caption><h1 align="center"><strong>Purchase Reports</strong></h1></caption>
                		<thead>
							<tr  align="center" >
								<th rowspan="1">Sl. No</th>
								<th rowspan="1">Invoice/Cash Bill No</th>
								<th rowspan="1">Date of Purchase</th>
								<th rowspan="1">Name & Address of the Supplier</th>
								<th rowspan="1">GSTIN</th>
								<th rowspan="1" colspan="1" class="sum">Invoice Amount</th>
								<th rowspan="1" class="sum" colspan="1">SGST</th>
