...
////Define Function
function bar128($text,$prd,$price) {						// Part 1, make list of widths
 ...
 # $text=$prd.$text;
  ...
  return "$html<tr><td  colspan=".strlen($w)." align=center><font family=arial size=2><b>$prd$text$price</table>";		
}
?>