...
{
	$query .= 'Where (inventory_order_id LIKE "%'.$_POST["search"]["value"].'%" ';
...
foreach($result as $row)
{
	...
	$sub_array[] = '<a href="view_quotation.php?order_id='.$row["inventory_order_id"].'" class="btn btn-info btn-xs">View Quotation</a>';
...
{
	$statement = $connect->prepare("SELECT * FROM qinventory_order");
	$statement->execute();
