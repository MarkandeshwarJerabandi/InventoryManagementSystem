		...
		<div class="col-lg-20">
			<div class="panel panel-default">
                ...
                <div class="panel-body">
					...
					<caption><h1 align="center"><strong>Sales Reports</strong></h1></caption>
                		<thead>
							<tr  align="center" >
								<th rowspan="1">Sl. No</th>
								<th rowspan="1">Invoice No</th>
								<th rowspan="1">Date of Sale</th>
								<th rowspan="1">Name & Address of the Customer</th>
								<th rowspan="1">GSTIN</th>
								<th rowspan="1" class="sum" colspan="1">Invoice Amount</th>
								<th rowspan="1" colspan="1" class="sum">SGST</th>
								<th rowspan="1" colspan="1" class="sum">CGST</th>
								<th rowspan="1" colspan="1" class="sum">Discount</th>
								<th rowspan="1" class="sum">Total Amount</th>
								<th rowspan="1">Dispatched Through</th>
								<th rowspan="1">Dispatch No</th>
								<th rowspan="1">Delivery Address</th>
								<th rowspan="1">Delivery Station</th>
								<th rowspan="1">Order No</th>
								<th rowspan="1">Order Date</th>
								<th rowspan="1">Truck No</th>
								<th rowspan="1">Broker</th>	
