...
{
	$query .= 'WHERE product.HSN_code LIKE "%'.$_POST["search"]["value"].'%" ';
...
foreach($result as $row)
{
	...
	$sub_array[] = $row['size'];
	//$sub_array[] = $row['grade'];
	$sub_array[] = $row["product_unit"];
	//$sub_array[] = $row["unit_conversion"];
	$sub_array[] = $row['tax_status'];
	$sub_array[] = $row['SGST'];
	$sub_array[] = $row["CGST"];
	$sub_array[] = $row["min_stock_quantity"];
